...
**Webhook** реєструється кнопкою в адмінці (endpoint `/api/telegram/webhook`). На Vercel
HTTPS-адреса підставляється автоматично. Запити до webhook захищені секретним заголовком
